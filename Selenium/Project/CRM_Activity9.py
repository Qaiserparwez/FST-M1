...
with webdriver.Firefox(service=service) as driver:
    ...
    for i in range(0, len(Row_element), 1):
        ...
        # Assuming the name is in the third column (td[3])
        # print("Name:", name)
        # name = row.find_element(By.XPATH,("//table[contains(@class,'responsive')]/tbody/tr['i']/td[3]"))
        # # # ("//*[@class='list view table-responsive']")
        # user = row.find_element(By.XPATH,("//table[contains(@class,'responsive')]/tbody/tr['i']/td[8]"))
        #print("Name displayed in Row number is: ",name.text, "and respective User ID is: ",user.text)
...
# Stop after printing the names of the first 5 odd-numbered rows
    ...
    #name = WebDriverWait(driver,20).until(EC.visibility_of_element_located((By.XPATH,"//table[contains(@class,'responsive')]/tbody/tr[i]/td[3]")))
    #user = WebDriverWait(driver,20).until(EC.visibility_of_element_located((By.XPATH,"//table[contains(@class,'responsive')]/tbody/tr[i]/td[8]")))
    #     name = row.find_element(By.XPATH,("//table[contains(@class,'responsive')]/tbody/tr['i']/td[3]"))
    # # # ("//*[@class='list view table-responsive']")
    #     user = row.find_element(By.XPATH,("//table[contains(@class,'responsive')]/tbody/tr['i']/td[8]"))
    #     print("Name displayed in Row number is: ",name.text, "and respective User ID is: ",user.text)
